...
fn srgb_to_linear(srgb: vec4<f32>) -> vec4<f32> {
    ...
    _ = (_e9 - vec3<f32>(0.040449999272823334));
    ...
    _ = ((_e24 + vec3<f32>(0.054999999701976776)) / vec3<f32>(1.0549999475479126));
    _ = vec3<f32>(2.4000000953674316);
...
fn main_1() {
    ...
    _ = textureSample(t_color, s_color, _e5);
    _ = in_uv_1;
